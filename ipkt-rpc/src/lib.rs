...
pub use drsr::{
    ...
    drs_get_nc_changes_request, drsu_bind_uuids, DrsUsnVector, DRS_INIT_SYNC, DRS_WRIT_REP,
    DRSUAPI_INTERFACE, EXOP_REPL_OBJ,
};
pub use drsr_crypto::{
...
pub use prefix_table::{
    make_attid, oid_from_attid, PrefixTable, ATTID_UNICODE_PWD, DEFAULT_REPL_ATTIDS, OID_UNICODE_PWD,
};
